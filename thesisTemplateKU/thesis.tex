...
\title{Run-Time Scheduling Support for Hybrid CPU/FPGA SoCs}
\author{Jason M. Agron}
\date{\Month\ \number\year}
\organization{%
%  \\[0.2in]
...
%  \\[0.2in]
  ...
  \vskip 3ex
  \copyright\ \the\year\ Jason M. Agron
}
...
\vskip 10ex
\textbf{Run-Time Scheduling Support for Hybrid CPU/FPGA SoCs}
